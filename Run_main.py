...
plt.plot(x3, y3, 'c-', linewidth = 0.1, label = 'Venus')
plt.plot(x4, y4, 'b-', linewidth = 0.1, label = 'Earth')
plt.plot(x5, y5, 'r-', linewidth = 0.1, label = 'Mars')
plt.plot(x6, y6, 'g-', linewidth = 0.1, label = 'Jupiter')
...
plt.savefig('SolarSystem.eps', format = 'eps', dpi = 10000, bbox_inches='tight')
